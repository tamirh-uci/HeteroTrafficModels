classdef phys80211 < handle
    methods (Static)
        ...
        % speed = [0,1] linear combination of min-max speed of the type
        % rate = (bits/second)
        function rate = MaxDatarate(type, wMin, speed)
            ...
            [datarateMin, datarateMax] = phys80211.RawDatarate(type);
            rawDatarate = speed * (datarateMax-datarateMin) + datarateMin;
            
            rate = rawDatarate * percentTransmitting;
        end
        
        % how fast individual transmissions send 
        % unit = [min, max] (bits/second)
        function [min, max] = RawDatarate(type)
            switch(type)
                case phys_80211_type.FHSS % 1-2 Mbit
                    min = 1000000;
                    max = 2000000;
                case phys_80211_type.DHSS % 1-2 Mbit
                    min = 1000000;
                    max = 2000000;
                case phys_80211_type.B % 1-11 Mbit
                    min = 1000000;
                    max = 11000000;
                case phys_80211_type.A % 1.5-54 Mbit
                    min = 1500000;
                    max = 54000000;
                case phys_80211_type.G % 1-54 Mbit
                    min = 1000000;
                    max = 54000000;
                case phys_80211_type.N24 % 1-600 Mbit
                    min = 1000000;
                    max = 600000000;
                case phys_80211_type.N50 % 1-600 Mbit
                    min = 1000000;
                    max = 600000000;
                case phys_80211_type.AC % 1-500 Mbit
                    min = 1000000;
                    max = 500000000;
            end
        end
        ...
        function sifs = SIFS(type)
            switch(type)
                case phys_80211_type.FHSS
                    sifs = 28;
                case phys_80211_type.DHSS
                    sifs = 10;
                case phys_80211_type.B
                    sifs = 10;
                case phys_80211_type.A
                    sifs = 16;
                case phys_80211_type.G
                    sifs = 10;
                case phys_80211_type.N24
                    sifs = 10;
                case phys_80211_type.N50
                    sifs = 16;
                case phys_80211_type.AC
                    sifs = 16;
            end
        end
        ...
        function slotTime = SlotTime(type)
            switch(type)
                ...
                case phys_80211_type.A
                    slotTime = 9;
                case phys_80211_type.G_short
                    slotTime = 9;
                case phys_80211_type.G_long
                    slotTime = 20;
                case phys_80211_type.N24_short
                    slotTime = 9;
                case phys_80211_type.N24_long
                    slotTime = 20;
                case phys_80211_type.N50
                    slotTime = 9;
                case phys_80211_type.AC
