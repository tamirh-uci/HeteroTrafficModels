                    ...
                    for j2 = 1:numEnter2
                        for j3 = numPackets2 
                            for j4 = numInterarrival2
                                ...
                                fName = sprintf('./../results/simulation_random_web-%d_%d_%d_%d_%d_%d_%d_%d.sim', pArrive1(i1), pEnter1(i2), nPackets1(i3), nInterarrival1(i4), pArrive2(j1), pEnter2(j2), nPackets2(j3), nInterarrival2(j4));
                                fprintf('\n------------\nrunning test: %s\n', fName);
                                fid = fopen(fName, 'w');
                                if (fid == -1)
                ...
                for j1 = 1:numArrive2
                    for j2 = 1:numEnter2
                        for j3 = numPackets2 
                            ...
                            fileName = sprintf('./../results/fig-simulation_random_web-interarival-%d_%d_%d_%d_%d_%d_%d.fig', pArrive1(i1), pEnter1(i2), nPackets1(i3), nInterarrival1(i4), pArrive2(j1), pEnter2(j2), nPackets2(j3));
                ...
                for j2 = 1:numEnter2
                    for j3 = numPackets2 
                        for j4 = numInterarrival2
                            ...
                            fileName = sprintf('./../results/fig-simulation_random_web-parrival-%d_%d_%d_%d_%d_%d_%d.fig', pArrive1(i1), pEnter1(i2), nPackets1(i3), nInterarrival1(i4), pEnter2(j2), nPackets2(j3), nInterarrival2(j4));
                            saveas(gcf,['.', filesep, fileName], 'fig');  % gca?
                        end
                    end
                end
                ...
                for j3 = numPackets2 
                    for j4 = numInterarrival2
                        for j1 = 1:numArrive2
                            ...
                            fileName = sprintf('./../results/fig-simulation_random_web-penter-%d_%d_%d_%d_%d_%d_%d.fig', pArrive1(i1), pEnter1(i2), nPackets1(i3), nInterarrival1(i4), pArrive2(j1), nPackets2(j3), nInterarrival2(j4));
                            saveas(gcf,['.', filesep, fileName], 'fig');  % gca?
                        end
                    end
                end
                ...
                for j4 = numInterarrival2
                    for j1 = 1:numArrive2
                        for j2 = 1:numEnter2
                            ...
                            fileName = sprintf('./../results/fig-simulation_random_web-maxpackets-%d_%d_%d_%d_%d_%d_%d.fig', pArrive1(i1), pEnter1(i2), nPackets1(i3), nInterarrival1(i4), pArrive2(j1), pEnter2(j2), nInterarrival2(j4));
                            saveas(gcf,['.', filesep, fileName], 'fig');  % gca?
                        end
                    end
                end
